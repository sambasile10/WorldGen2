...
/*
 * ===============================
 * Credit for this class to: 
 *  + Stefan Gustavson (stegu@itn.liu.se)
 *  + Peter Eastman (peastman@drizzle.stanford.edu)
 *  
 *  I made minor changes to get this object
 *  to be implemented as a Thread for concurrency
 * ===============================
 */
...
public class SimplexNoiseOctave {
	...
	// this contains all the numbers between 0 and 255, these are put in a random
	// order depending upon the seed
	private static short p_supply[] = { 151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140, 36,
